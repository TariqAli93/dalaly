...
export const RENTAL_PROPERTY_TYPES = ["house", "apartment", "shop", "warehouse", "other"] as const;
export const RENT_PERIODS = ["monthly", "semi_annual", "annual"] as const;
export const RENTAL_STATUSES = ["available", "reserved", "negotiating", "rented", "archived"] as const;
